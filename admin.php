        ...
        <div id="menu-management">
            ...
            <div id="productsContainer">
                ...
                while ($category = $result_categories->fetch_assoc()) {
                    ...
                    echo "<h3>" . htmlspecialchars($category['maincategory']) . "</h3>";
                    ...
                    while ($subcategory = $result_subcategories->fetch_assoc()) {
                        ...
                        echo "<h4>" . htmlspecialchars($subcategory['subcategory']) . "</h4>";
                        ...
                        while ($product = $result_products->fetch_assoc()) {
                            ...
                            echo "<div>";
                            echo "<div>ID: <span class='text'>" . htmlspecialchars($product['id']) . "</span></div>";
                            echo "<div>Name: <span class='text'>" . htmlspecialchars($product['name']) . "</span></div>";
